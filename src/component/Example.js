    ...
    <>{loading && <div className='grid lg:grid-cols-4 md:grid-cols-4 grid-cols-2  py-8 bg-black'><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /><Loading /></div>}
      {!loading && <div>
        <div className='w-screen h-16 flex  flex-row items-center bg-gradient-to-r from-purple-500 to-pink-500'>
          ...
          <div className="w3/4">
            <input type="text" placeholder="search here movie....." className='  mx-2 md:w-[500px] lg:w-[800px] px-2 bg-white md:h-10 rounded-full shadow-inner shadow-black' onChange={event => {setsearchdata(event.target.value) ; setsearch(true)}} ></input>
