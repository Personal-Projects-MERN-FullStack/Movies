...
function Moviepage() {
  ...
  useEffect(async () => {
    try {
      ...
      alert(`Pls Chekc Your Internet Connection or Refresh Page ${e}`);
    }
  }, [page, sort]);
  const onclickhander = () => {
    setsearch(false);
  ...
  //https://movie-task.vercel.app/api/search?page=1&query=Avengers
        ...
        <div>
          <div className="w-screen h-16 flex  flex-row items-center bg-gradient-to-r from-purple-500 to-pink-500">
            ...
            <div className="w3/4 flex items-center">
              <input
                ...
                className="cursor-text  mx-2 md:w-[500px] lg:w-[800px] px-2 bg-white md:h-10 rounded-full shadow-inner shadow-black"
                value={searchdata}
                onChange={(event) => {
              ...
              ></input>
              <svg
                className={`svg-icon md:h-8 md:w-8 h-5 w-5 cursor-pointer  ${
                  !search && "hidden"
                }`}
          ...
          >
            ...
            <motion.div
              ...
              className="info   w-1/4 overflow-scroll scrollbar-hide"
            >
              <motion.ul
                drag="y"
                      ...
                      <div className=" flex flex-row  w-full h-20 items-center">
                        <div className="w-1/4 ">
                          <img
                            ...
                            className="cursor-pointer h-16 w-16 rounded-full mt-2 ml-2"
                            alt="dp"
                          ></img>
                        </div>
                        <div className="w-3/4  ">
          ...
          <div>
            <div className="flex items-center justify-center space-x-8 bg-gradient-to-r pb-8 from-purple-500 to-pink-500">
              <button
                className={`${
                  page <= 1 && "hidden"
                } text-lg ml-3 font-medium leading-none shadow-lg shadow-black bg-white hover:shadow-white border border-black rounded-lg h-8 w-20 `}
              ...
              <button
                className="text-lg font-medium leading-none mr-3 shadow-lg shadow-black hover:shadow-white bg-white border border-black rounded-lg  h-8 w-20"
